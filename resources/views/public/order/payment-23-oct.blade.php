...
<body>
    ...
    <div class="container mx-auto text-center mt-5 pt-5">
        ...
        <a class="button wc-forward text-center btn-sm" href="{{guard_url('order/order')}}">Order History </a> 
        <a class="button wc-forward text-center btn-sm" href="{{trans_url('/')}}">home </a> 
