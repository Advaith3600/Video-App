...
@foreach($data as $key => $value)
       ...
       <div class="app-item " data-id="task_1"  data-action='EDIT' data-load-to="#app-entry"
        data-url="{{guard_url('order/order')}}/{{$value['id']}}/edit">
            ...
            <div class="app-info" data-action='EDIT' data-load-to="#app-entry"
                        data-url="{{guard_url('order/order')}}/{{$value['id']}}/edit">
            ...
            <div class="app-actions">
                <a href="{{guard_url('order/order')}}/{{$value['id']}}" class="btn las la-pencil-alt" data-action='EDIT'
                    data-load-to="#app-entry" data-url="{{guard_url('order/order')}}/{{$value['id']}}/edit">
                </a>
            </div>
      </div>
@endforeach
